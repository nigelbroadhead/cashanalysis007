...
public class BankaccountController implements Serializable {
    ...
    @EJB
    private dyall.facade.BankaccountFacade ejbFacade;
    ...
    public Bankaccount getBankaccount(java.lang.Long id) {
